...
#
# EXAMPLE:  qsub -l nodes=13:ppn=8 -v "N_PROC=21, N_ROWS=1000, N_COLS=1000, N_COMP=10, N_ITER=100, COMP_ERR=1, PRINT_ERR=0" batch.sh
#
...
mpiexec -n $N_PROC ./dnmf_exec $N_ROWS $N_COLS $N_COMP $N_ITER $COMP_ERR $PRINT_ERR
